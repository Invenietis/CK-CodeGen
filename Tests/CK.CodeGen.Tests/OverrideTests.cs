...
//                   {
//                       body.RawAppend( "return x + '-' + g.ToString();" );
//                   } )
...
//                        .DefineOverrideMethod( t.GetMethod( "Simple1" ), body =>
//                           {
//                               body.RawAppend( "if (arg.Equals(default(T))) throw new System.ArgumentException();" )
//                                   .RawAppend( "return default(TResult);" );
//                           } )
//                        .DefineOverrideMethod( t.GetMethod( "Simple2" ), body =>
//                           {
//                               body.RawAppend( "=> arg2 is T1" );
//                           } );
//            // TODO
//            //string source = b.CreateSource();
//            //Assembly[] references = new[]
