...
namespace CK.CodeGen
{
    ...
    public struct GenerateResult
    {
        ...
        /// <summary>
        /// Error raised by the emit itself.
        /// in this case 
        /// </summary>
        public readonly Exception EmitError;

        /// <summary>
        /// Error resulting from the attempt to load the <see cref="Assembly"/> if any.
        /// </summary>
        ...
        public GenerateResult(Exception eE, EmitResult r, Assembly a, Exception e)
        {
            EmitError = eE;
            Assembly = a;
            EmitResult = r;
